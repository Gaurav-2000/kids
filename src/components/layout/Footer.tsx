          ...
          <div>
            <Link href="/" className="inline-block mb-4">
              <SafeImage
                ...
                fallbackSrc="data:image/svg+xml;base64,"
              />
            </Link>
